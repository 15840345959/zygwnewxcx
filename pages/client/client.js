...
//案场负责人的navbar样式
var ac_navbar = [{ value: "ac0", name: "待接收" }, { value: "ac1", name: "待到访" }, { value: "ac2", name: "待成交" }, { value: "ac3", name: "待签约" }, { value: "ac4", name: "待全款到账" }, , { value: "ac5", name: "待结算" }, { value: "ac6", name: "已结算" }];
...
Page({
  ...
  onLoad: function (options) {
    ...
    var userInfo = util.getLocalUserInfo();
    console.log("onLoad userInfo:" + JSON.stringify(userInfo));
    set_role = userInfo.role;   //设定用户角色
    vm.setNavTab(); //刷新页面
    vm.getDatasFromSrv();
  },
  //设置头部导航条
      ...
      if (set_role == "0") {
        switch (cur) {
          case 0:
            ...
            delete search_param.pay_zhongie_status;
            break;
          case 1:
